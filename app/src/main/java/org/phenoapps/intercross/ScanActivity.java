...
public class ScanActivity extends AppCompatActivity {
    ...
    private BarcodeCallback callback = new BarcodeCallback() {
        ...
        public void barcodeResult(BarcodeResult result) {
            ...
            ImageView imageView = (ImageView) findViewById(org.phenoapps.intercross.R.id.barcodePreview);
            imageView.setImageBitmap(result.getBitmapWithResultPoints(Color.GREEN));

            final Intent i = new Intent();
            i.putExtra(IntercrossConstants.CAMERA_RETURN_ID, result.getText());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barcodeScannerView = (DecoratedBarcodeView)
                findViewById(org.phenoapps.intercross.R.id.zxing_barcode_scanner);
