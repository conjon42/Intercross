...
public class LoaderDBActivity extends AppCompatActivity {
    ...
    private void initializeUI() {
        ...
        headerList = ((ListView) findViewById(org.phenoapps.intercross.R.id.headerList));
        ...
        separatorText = (EditText) findViewById(org.phenoapps.intercross.R.id.separatorTextView);

        pairLayout = (LinearLayout) findViewById(R.id.pairLayout);
        choosePairButton = (Button) findViewById(org.phenoapps.intercross.R.id.choosePairButton);
        chooseHeaderButton = (Button) findViewById(org.phenoapps.intercross.R.id.chooseHeaderButton);
        doneButton = ((Button) findViewById(org.phenoapps.intercross.R.id.doneButton));
        finishButton = ((Button) findViewById(org.phenoapps.intercross.R.id.finishButton));
        ...
        chooseHeaderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tutorialText.setText(org.phenoapps.intercross.R.string.choose_pair_button_tutorial);
        ...
        choosePairButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tutorialText.setText(org.phenoapps.intercross.R.string.columns_tutorial);
        ...
        finishButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(IntercrossConstants.LIST_ID_EXTRA, mIdHeader);
                intent.putExtra(IntercrossConstants.PAIR_COL_EXTRA, mPairCol);
    ...
    private void displayHeaderList() {
        ...
        tutorialText.setText(org.phenoapps.intercross.R.string.choose_header_tutorial);
        chooseHeaderButton.setVisibility(View.VISIBLE);
        chooseHeaderButton.setEnabled(false);
        headerList.setVisibility(View.VISIBLE);

        if (mHeader == null) {
            headerList.setAdapter(new ArrayAdapter<String>(this, org.phenoapps.intercross.R.layout.row));
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        if (mFileUri != null)
            outState.putString(IntercrossConstants.CSV_URI, mFileUri.toString());
    }
