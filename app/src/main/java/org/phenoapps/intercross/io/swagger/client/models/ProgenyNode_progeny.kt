...
/**
 * 
 * @param germplasmDbId The unique identifier of a progeny germplasm
 * @param germplasmName The human readable name of a progeny germplasm
 * @param parentType Given a germplasm A having a progeny B and C, 'parentType' for progeny B item refers to the 'parentType' of A toward B.
 */
data class ProgenyNodeProgeny (
    ...
    val parentType: ProgenyNodeProgeny.ParentType
,
