...
/**
 * 
 * @param scaleDbId Unique identifier of the scale. If left blank, the upload system will automatically generate a scale ID.
 */
data class AllOfVariableBaseClassScale (
    /* Unique identifier of the scale. If left blank, the upload system will automatically generate a scale ID. */
    val scaleDbId: kotlin.String,
