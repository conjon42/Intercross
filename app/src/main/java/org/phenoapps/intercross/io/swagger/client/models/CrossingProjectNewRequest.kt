 ...
 * @param commonCropName the common name of a crop (for multi-crop systems)
 * @param crossingProjectDescription the description for a crossing project
 * @param crossingProjectName the human readable name for a crossing project
 * @param externalReferences 
 * @param programDbId the unique identifier for a program
 * @param programName the human readable name for a program
 */
data class CrossingProjectNewRequest (
    ...
    val crossingProjectDescription: kotlin.String? = null,
    ...
    val programName: kotlin.String? = null
) {
}