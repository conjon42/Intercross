 ...
 * @param dataType 
 * @param decimalPlaces For numerical, number of decimal places to be reported
 * @param externalReferences 
 * @param ontologyReference 
 * @param scaleName Name of the scale  MIAPPE V1.1 (DM-92) Scale Name of the scale associated with the variable
 * @param validValues 
 */
data class ScaleBaseClass (
    /* Name of the scale  MIAPPE V1.1 (DM-92) Scale Name of the scale associated with the variable */
    val scaleName: kotlin.String
,
    /* Additional arbitrary info */
    val additionalInfo: kotlin.collections.Map<kotlin.String, kotlin.String>? = null,
    val dataType: TraitDataType? = null,
    ...
    val validValues: ScaleBaseClassValidValues? = null
) {
}