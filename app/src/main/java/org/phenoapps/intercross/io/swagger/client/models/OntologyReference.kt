 ...
 * @param documentationLinks links to various ontology documentation
 * @param ontologyDbId Ontology database unique identifier
 * @param ontologyName Ontology name
 * @param version Ontology version (no specific format)
 */
data class OntologyReference (
    /* Ontology database unique identifier */
    val ontologyDbId: kotlin.String,
    /* Ontology name */
    val ontologyName: kotlin.String
,
    /* links to various ontology documentation */
    val documentationLinks: kotlin.Array<OntologyReferenceDocumentationLinks>? = null,
