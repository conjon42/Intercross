...
/**
 * 
 * @param attributeCategory General category for the attribute. very similar to Trait class.
 * @param attributeDescription A human readable description of this attribute
 * @param attributeName A human readable name for this attribute
 */
data class GermplasmAttributeNewRequest (
    /* A human readable name for this attribute */
    val sattributeName: kotlin.String,
    val method: kotlin.Any,
    val scale: kotlin.Any,
    val trait: kotlin.Any,
    /* A human readable name for this attribute */
    val attributeName: kotlin.String,
    /* General category for the attribute. very similar to Trait class. */
    val attributeCategory: kotlin.String? = null,
    /* A human readable description of this attribute */
    val attributeDescription: kotlin.String? = null,
