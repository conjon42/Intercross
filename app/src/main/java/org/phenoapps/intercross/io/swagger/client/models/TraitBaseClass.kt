 ...
 * @param alternativeAbbreviations Other frequent abbreviations of the trait, if any. These abbreviations do not have to follow a convention
 * @param attribute A trait can be decomposed as \"Trait\" = \"Entity\" + \"Attribute\", the attribute is the observed feature (or characteristic) of the entity e.g., for \"grain colour\", attribute = \"colour\"
 * @param entity A trait can be decomposed as \"Trait\" = \"Entity\" + \"Attribute\", the entity is the part of the plant that the trait refers to e.g., for \"grain colour\", entity = \"grain\"
 * @param externalReferences 
 * @param mainAbbreviation Main abbreviation for trait name. (examples: \"Carotenoid content\" => \"CC\")
 * @param ontologyReference 
 * @param status Trait status (examples: \"recommended\", \"obsolete\", \"legacy\", etc.)
 * @param synonyms Other trait names
 * @param traitClass Trait class. (examples: \"morphological\", \"phenological\", \"agronomical\", \"physiological\", \"abiotic stress\", \"biotic stress\", \"biochemical\", \"quality traits\", \"fertility\", etc.)
 * @param traitDescription The description of a trait
 * @param traitName The human readable name of a trait  MIAPPE V1.1 (DM-86) Trait - Name of the (plant or environmental) trait under observation
 */
data class TraitBaseClass (
    ...
    val alternativeAbbreviations: kotlin.Array<kotlin.String>? = null,
    ...
    val mainAbbreviation: kotlin.String? = null,
