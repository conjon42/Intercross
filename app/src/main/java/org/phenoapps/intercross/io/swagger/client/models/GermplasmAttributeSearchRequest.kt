 ...
 * @param studyDbId The unique ID of a studies to filter on
 ...
 */
data class GermplasmAttributeSearchRequest (
    ...
    val attributeDbIds: kotlin.Array<kotlin.String>? = null,
    /* List of human readable Germplasm Attribute names to search for */
    val attributeNames: kotlin.Array<kotlin.String>? = null,
    /* List of scale data types to filter search results */
    val dataTypes: kotlin.Array<TraitDataType>? = null,
    /* List of methods to filter search results */
    val methodDbIds: kotlin.Array<kotlin.String>? = null,
    /* List of ontology IDs to search for */
    val ontologyDbIds: kotlin.Array<kotlin.String>? = null,
    /* List of scales to filter search results */
    val scaleDbIds: kotlin.Array<kotlin.String>? = null,
    /* The unique ID of a studies to filter on */
    val studyDbId: kotlin.Array<kotlin.String>? = null,
    /* List of trait classes to filter search results */
    val traitClasses: kotlin.Array<kotlin.String>? = null,
    /* List of trait unique ID to filter search results */
    val traitDbIds: kotlin.Array<kotlin.String>? = null,
