...
/**
 * 
 * @param crossDbId the unique identifier for a cross
 */
class Cross (

    /* the unique identifier for a cross */
    val crossDbId: kotlin.String? = null,
    ...
    val crossAttributes: Array<CrossNewRequestCrossAttributes>? = null,
    /* the human readable name for a cross */
    val crossName: kotlin.String? = null,
    /* the type of cross */
    val crossType: Cross.CrossType? = null,
    ...
    /**
     * Enum class NOT generated by swagger hub
     */
    enum class CrossType {
        BIPARENTAL, SELF, OPEN_POLLINATED, BULK, BULK_SELFED, BULK_OPEN_POLLINATED, DOUBLE_HAPLOID
    }
}