 ...
 * @param amount The amount of units being transfered. Could be a count (seeds, bulbs, etc) or a weight (kg of seed).
 * @param externalReferences 
 * @param fromSeedLotDbId The identifier for the Seed Lot being transfered out of
 * @param toSeedLotDbId The identifier for the Seed Lot being transfered into
 * @param transactionDescription A general description of this Seed Lot Transaction
 * @param transactionTimestamp The time stamp for when the transaction occured
 * @param units Description of the things being transfered in this transaction (seeds, bulbs, kg, etc)
 */
data class SeedLotNewTransactionRequest (
    ...
    val fromSeedLotDbId: kotlin.String? = null,
    /* The identifier for the Seed Lot being transfered into */
    val toSeedLotDbId: kotlin.String? = null,
    /* A general description of this Seed Lot Transaction */
    val transactionDescription: kotlin.String? = null,
    /* The time stamp for when the transaction occured */
    val transactionTimestamp: java.time.LocalDateTime? = null,
