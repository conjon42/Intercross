 ...
 * @param bibliographicalReference Bibliographical reference describing the method.  MIAPPE V1.1 (DM-91) Reference associated to the method - URI/DOI of reference describing the method.
 * @param description Method description  MIAPPE V1.1 (DM-90) Method description - Textual description of the method, which may extend a method defined in an external reference with specific parameters, e.g. growth stage, inoculation precise organ (leaf number)
 * @param externalReferences 
 * @param formula For computational methods i.e., when the method consists in assessing the trait by computing measurements, write the generic formula used for the calculation
 * @param methodClass Method class (examples: \"Measurement\", \"Counting\", \"Estimation\", \"Computation\", etc.)
 * @param methodName Human readable name for the method  MIAPPE V1.1 (DM-88) Method  Name of the method of observation
 * @param ontologyReference 
 */
data class MethodBaseClass (
    ...
    val bibliographicalReference: kotlin.String? = null,
