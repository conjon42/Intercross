...
/**
 * 
 * @param attributeValueDbId The ID which uniquely identifies this attribute value within the given database server
 */
data class GermplasmAttributeValue (
    /* The ID which uniquely identifies this attribute value within the given database server */
    val attributeValueDbId: kotlin.String,
